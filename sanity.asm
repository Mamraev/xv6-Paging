...
main(int argc, char *argv[]){
  ...
  11:	e8 3a 00 00 00       	call   50 <SwapFileTest>
  if(res == -1){
  ...
  1b:	50                   	push   %eax
  1c:	50                   	push   %eax
  1d:	68 4c 08 00 00       	push   $0x84c
  22:	6a 01                	push   $0x1
  24:	e8 b7 04 00 00       	call   4e0 <printf>
  29:	83 c4 10             	add    $0x10,%esp
  exit();
  2c:	e8 61 03 00 00       	call   392 <exit>
    printf(1," FAILED\n");
  31:	52                   	push   %edx
  32:	52                   	push   %edx
  33:	68 43 08 00 00       	push   $0x843
  38:	6a 01                	push   $0x1
  3a:	e8 a1 04 00 00       	call   4e0 <printf>
...
00000050 <SwapFileTest>:
SwapFileTest(){
  50:	55                   	push   %ebp
  51:	89 e5                	mov    %esp,%ebp
  53:	53                   	push   %ebx
  54:	83 ec 7c             	sub    $0x7c,%esp
  printf(1,"SwapFile :");
  57:	68 38 08 00 00       	push   $0x838
  5c:	6a 01                	push   $0x1
  5e:	e8 7d 04 00 00       	call   4e0 <printf>
  for(i = 0; i < 25; i++){
  63:	c7 45 90 00 00 00 00 	movl   $0x0,-0x70(%ebp)
  6a:	8b 45 90             	mov    -0x70(%ebp),%eax
  6d:	83 c4 10             	add    $0x10,%esp
  70:	83 f8 18             	cmp    $0x18,%eax
  73:	7f 37                	jg     ac <SwapFileTest+0x5c>
  75:	8d 76 00             	lea    0x0(%esi),%esi
    lst[i] = (int*)sbrk(PGSIZE);
  78:	83 ec 0c             	sub    $0xc,%esp
  7b:	8b 5d 90             	mov    -0x70(%ebp),%ebx
  7e:	68 00 10 00 00       	push   $0x1000
  83:	e8 92 03 00 00       	call   41a <sbrk>
  88:	89 44 9d 94          	mov    %eax,-0x6c(%ebp,%ebx,4)
    *lst[i]=i;
  8c:	8b 45 90             	mov    -0x70(%ebp),%eax
  for(i = 0; i < 25; i++){
  8f:	83 c4 10             	add    $0x10,%esp
    *lst[i]=i;
  92:	8b 55 90             	mov    -0x70(%ebp),%edx
  95:	8b 44 85 94          	mov    -0x6c(%ebp,%eax,4),%eax
  99:	89 10                	mov    %edx,(%eax)
  for(i = 0; i < 25; i++){
  9b:	8b 45 90             	mov    -0x70(%ebp),%eax
  9e:	83 c0 01             	add    $0x1,%eax
  a1:	89 45 90             	mov    %eax,-0x70(%ebp)
  a4:	8b 45 90             	mov    -0x70(%ebp),%eax
  a7:	83 f8 18             	cmp    $0x18,%eax
  aa:	7e cc                	jle    78 <SwapFileTest+0x28>
  for(i = 0; i < 25; i++){
  ac:	c7 45 90 00 00 00 00 	movl   $0x0,-0x70(%ebp)
  b3:	8b 45 90             	mov    -0x70(%ebp),%eax
  b6:	83 f8 18             	cmp    $0x18,%eax
  b9:	7e 16                	jle    d1 <SwapFileTest+0x81>
  bb:	eb 33                	jmp    f0 <SwapFileTest+0xa0>
  bd:	8d 76 00             	lea    0x0(%esi),%esi
  c0:	8b 45 90             	mov    -0x70(%ebp),%eax
  c3:	83 c0 01             	add    $0x1,%eax
  c6:	89 45 90             	mov    %eax,-0x70(%ebp)
  c9:	8b 45 90             	mov    -0x70(%ebp),%eax
  cc:	83 f8 18             	cmp    $0x18,%eax
  cf:	7f 1f                	jg     f0 <SwapFileTest+0xa0>
    if(*lst[i]!=i){
  d1:	8b 55 90             	mov    -0x70(%ebp),%edx
  d4:	8b 45 90             	mov    -0x70(%ebp),%eax
  d7:	8b 54 95 94          	mov    -0x6c(%ebp,%edx,4),%edx
  db:	39 02                	cmp    %eax,(%edx)
  dd:	74 e1                	je     c0 <SwapFileTest+0x70>
      return -1;
...
00000100 <printResult>:
printResult(int res){
 100:	55                   	push   %ebp
 101:	89 e5                	mov    %esp,%ebp
 103:	83 ec 08             	sub    $0x8,%esp
  if(res == -1){
 106:	83 7d 08 ff          	cmpl   $0xffffffff,0x8(%ebp)
 10a:	74 14                	je     120 <printResult+0x20>
    printf(1," PASSED\n");
 10c:	83 ec 08             	sub    $0x8,%esp
 10f:	68 4c 08 00 00       	push   $0x84c
 114:	6a 01                	push   $0x1
 116:	e8 c5 03 00 00       	call   4e0 <printf>
 ...
 123:	68 43 08 00 00       	push   $0x843
 128:	6a 01                	push   $0x1
 12a:	e8 b1 03 00 00       	call   4e0 <printf>
 ...
 449:	85 d2                	test   %edx,%edx
{
 ...
 477:	f7 f1                	div    %ecx
 479:	0f b6 92 5c 08 00 00 	movzbl 0x85c(%edx),%edx
  }while((x /= base) != 0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 694:	e9 8f fe ff ff       	jmp    528 <printf+0x48>
          s = "(null)";
 699:	bb 55 08 00 00       	mov    $0x855,%ebx
        while(*s != 0){
