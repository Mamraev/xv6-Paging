...
cowSwapFile_maxPhyInChildTest(){
 ...
 437:	0f 8c e0 00 00 00    	jl     51d <cowSwapFile_maxPhyInChildTest+0x13d>
  int pid = fork();
 43d:	e8 28 06 00 00       	call   a6a <fork>
  if(pid==0){
 442:	85 c0                	test   %eax,%eax
 444:	75 5a                	jne    4a0 <cowSwapFile_maxPhyInChildTest+0xc0>
 ...
 44d:	8d 40 44             	lea    0x44(%eax),%eax
 450:	39 d8                	cmp    %ebx,%eax
 452:	0f 85 dd 00 00 00    	jne    535 <cowSwapFile_maxPhyInChildTest+0x155>
 458:	b8 32 00 00 00       	mov    $0x32,%eax
 ...
 47b:	7d 73                	jge    4f0 <cowSwapFile_maxPhyInChildTest+0x110>
      printf(1," FAILED 3(Free Memory error)%d\n",getNumberOfFreePages());
 47d:	e8 90 06 00 00       	call   b12 <getNumberOfFreePages>
 482:	83 ec 04             	sub    $0x4,%esp
 485:	50                   	push   %eax
 486:	68 00 11 00 00       	push   $0x1100
 48b:	6a 01                	push   $0x1
 48d:	e8 3e 07 00 00       	call   bd0 <printf>
      exit();
 492:	e8 db 05 00 00       	call   a72 <exit>
 497:	89 f6                	mov    %esi,%esi
 499:	8d bc 27 00 00 00 00 	lea    0x0(%edi,%eiz,1),%edi
  wait();
 4a0:	e8 d5 05 00 00       	call   a7a <wait>
  for(i = 0; i < 20; i++){
 4a5:	31 c0                	xor    %eax,%eax
 4a7:	eb 0f                	jmp    4b8 <cowSwapFile_maxPhyInChildTest+0xd8>
 4a9:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
 4b0:	83 c0 01             	add    $0x1,%eax
 4b3:	83 f8 14             	cmp    $0x14,%eax
 4b6:	74 3d                	je     4f5 <cowSwapFile_maxPhyInChildTest+0x115>
      if(*lst[i]!=i){
 4b8:	8b 54 85 a8          	mov    -0x58(%ebp,%eax,4),%edx
 4bc:	39 02                	cmp    %eax,(%edx)
 4be:	74 f0                	je     4b0 <cowSwapFile_maxPhyInChildTest+0xd0>
        printf(1,"\nparent fail %d %d\n",*lst[i]!=i);
 4c0:	83 ec 04             	sub    $0x4,%esp
 4c3:	6a 01                	push   $0x1
 4c5:	68 8a 0f 00 00       	push   $0xf8a
 4ca:	6a 01                	push   $0x1
 4cc:	e8 ff 06 00 00       	call   bd0 <printf>
        printf(1," FAILED");
 4d1:	58                   	pop    %eax
 4d2:	5a                   	pop    %edx
 4d3:	68 57 0f 00 00       	push   $0xf57
 4d8:	6a 01                	push   $0x1
 4da:	e8 f1 06 00 00       	call   bd0 <printf>
        return -1;
 ...
 4ee:	66 90                	xchg   %ax,%ax
    exit();
 4f0:	e8 7d 05 00 00       	call   a72 <exit>
    if(freePages >getNumberOfFreePages()+16){
 4f5:	e8 18 06 00 00       	call   b12 <getNumberOfFreePages>
 4fa:	8d 50 10             	lea    0x10(%eax),%edx
  return 0;
 4fd:	31 c0                	xor    %eax,%eax
    if(freePages >getNumberOfFreePages()+16){
 4ff:	39 f2                	cmp    %esi,%edx
 501:	7d e4                	jge    4e7 <cowSwapFile_maxPhyInChildTest+0x107>
      printf(1," FAILED 4(Free Memory error)\n");
 503:	83 ec 08             	sub    $0x8,%esp
 506:	89 45 a4             	mov    %eax,-0x5c(%ebp)
 509:	68 9e 0f 00 00       	push   $0xf9e
 50e:	6a 01                	push   $0x1
 510:	e8 bb 06 00 00       	call   bd0 <printf>
 515:	83 c4 10             	add    $0x10,%esp
 518:	8b 45 a4             	mov    -0x5c(%ebp),%eax
 51b:	eb ca                	jmp    4e7 <cowSwapFile_maxPhyInChildTest+0x107>
    printf(1," FAILED 1(Free Memory error) %d\n",getNumberOfFreePages());
 51d:	e8 f0 05 00 00       	call   b12 <getNumberOfFreePages>
 522:	51                   	push   %ecx
 523:	50                   	push   %eax
 524:	68 b8 10 00 00       	push   $0x10b8
 529:	6a 01                	push   $0x1
 52b:	e8 a0 06 00 00       	call   bd0 <printf>
    exit();
 530:	e8 3d 05 00 00       	call   a72 <exit>
    printf(1," FAILED 2(Free Memory error) %d %d\n",freePagesAfterFork,freePagesAfterSBRK);
 535:	53                   	push   %ebx
 536:	56                   	push   %esi
 537:	68 dc 10 00 00       	push   $0x10dc
 53c:	6a 01                	push   $0x1
 53e:	e8 8d 06 00 00       	call   bd0 <printf>
    exit();
 543:	e8 2a 05 00 00       	call   a72 <exit>
 548:	90                   	nop
