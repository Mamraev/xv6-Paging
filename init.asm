...
main(void)
{
  ...
  c9:	6a 01                	push   $0x1
  cb:	6a 01                	push   $0x1
  cd:	68 2d 08 00 00       	push   $0x82d
  d2:	e8 e3 02 00 00       	call   3ba <mknod>
    open("console", O_RDWR);
  d7:	58                   	pop    %eax
  d8:	5a                   	pop    %edx
  d9:	6a 02                	push   $0x2
  db:	68 2d 08 00 00       	push   $0x82d
...
printf(int fd, const char *fmt, ...)
{
 ...
 684:	e9 8f fe ff ff       	jmp    518 <printf+0x48>
          s = "(null)";
 689:	bb 7d 08 00 00       	mov    $0x87d,%ebx
        while(*s != 0){
